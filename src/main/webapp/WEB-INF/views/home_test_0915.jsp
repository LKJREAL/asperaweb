...
-->
	...
	-->
						...
						<div class="input-group">
							<input id="logoutBtn" type="button" class="btn btn-danger" style="position: absolute; right: 230px; top: 40px; width 120px" value="Log Out">
						</div>
						...
						<div class="visual">
							<div class="banner_wrap">
								...
								<div class="display-1" style="display: table; margin-left: auto; margin-right: auto;font-family: Arial;font-size: 48px;font-weight: 700;color: #f8f9fa;background-color: transparent;">IBM ASPERA</div>
...
-->
		...
		<div class="row" id="uploadArea">
			<div class="col-lg-5">
				...
				<div class="input-group">
					<button class="btn btn-success btn-sm" id="refresh" type="button" name="${self.path }">Refresh</button>&nbsp;
					<button class="btn btn-success btn-sm" id="create" type="button" name="${self.path }">Create Folder</button>&nbsp;
          			<button class="btn btn-success btn-sm" id="downloadBtn" type="button" name="${self.path }">Download</button>&nbsp;
					<button class="btn btn-success btn-sm" id="uploadfile" type="button" name="${self.path }">Upload File</button>&nbsp;
					<button class="btn btn-success btn-sm" id="uploadfolder" type="button" name="${self.path }">Upload Folder</button>&nbsp;
					<button class="btn btn-success btn-sm" id="deleteBtn" type="button" name="${self.path }">Delete Files/Folders</button>&nbsp;
